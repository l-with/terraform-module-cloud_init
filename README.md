...
| <a name="input_vault_provide_vault_init_json"></a> [vault\_provide\_vault\_init\_json](#input\_vault\_provide\_vault\_init\_json) | if the vault init json result should be provided for fetching | `bool` | `false` | no |
