...
| <a name="input_rke2_node_other_vars"></a> [rke2\_node\_other\_vars](#input\_rke2\_node\_other\_vars) | the variables for cloud-init user data for rke2 other masters | <pre>object({<br>    rke2_node_1st_ip = string<br>  })</pre> | <pre>{<br>  "rke2_node_1st_ip": ""<br>}</pre> | no |
