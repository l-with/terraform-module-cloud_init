...
| <a name="input_rke2_master_1st_cert_manager_crd_version"></a> [rke2\_master\_1st\_cert\_manager\_crd\_version](#input\_rke2\_master\_1st\_cert\_manager\_crd\_version) | the version of cert-manager CRDs to be installed | `string` | `"1.11.0"` | no |
| <a name="input_rke2_master_1st_rke2_role_id"></a> [rke2\_master\_1st\_rke2\_role\_id](#input\_rke2\_master\_1st\_rke2\_role\_id) | the role id for the app role in vault to login and get the token to put the `rke2.yaml` as kv into vault | `string` | n/a | yes |
| <a name="input_rke2_master_1st_rke2_secret_id"></a> [rke2\_master\_1st\_rke2\_secret\_id](#input\_rke2\_master\_1st\_rke2\_secret\_id) | the role id for the app role in vault to login and get the token to put the `rke2.yaml` as kv into vault | `string` | n/a | yes |
| <a name="input_rke2_master_1st_vault_addr"></a> [rke2\_master\_1st\_vault\_addr](#input\_rke2\_master\_1st\_vault\_addr) | the vault address to put the `ke2.yml`  as kv into | `string` | `""` | no |
| <a name="input_rke2_master_1st_vault_field"></a> [rke2\_master\_1st\_vault\_field](#input\_rke2\_master\_1st\_vault\_field) | the vault field used to put the `rke2.yaml` as kv into vault | `string` | `"rke2_yaml"` | no |
| <a name="input_rke2_master_1st_vault_mount"></a> [rke2\_master\_1st\_vault\_mount](#input\_rke2\_master\_1st\_vault\_mount) | the vault mount used to put the `rke2.yaml` as kv into vault | `string` | `"gitlab"` | no |
| <a name="input_rke2_master_1st_vault_path"></a> [rke2\_master\_1st\_vault\_path](#input\_rke2\_master\_1st\_vault\_path) | the vault path used to put the `rke2.yaml` as kv into vault | `string` | `"rancher/kubeconfig"` | no |
