...
locals {
  ...
  cloud_init_parts = {
    ...
    cloud_init_write_files_fail2ban       = var.fail2ban ? local.cloud_init_write_files_fail2ban : ""
    ...
    cloud_init_runcmd_fail2ban            = var.fail2ban ? local.cloud_init_runcmd_fail2ban : ""
