...
locals {
  ...
  cloud_init_parts = {
    ...
    cloud_init_packages_certbot           = var.certbot ? module.certbot[0].packages : "" // local.cloud_init_package_certbot : ""
    ...
    cloud_init_runcmd_certbot             = var.certbot ? module.certbot[0].runcmd : "" // local.cloud_init_runcmd_certbot : ""
